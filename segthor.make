...
TRN = results/segthor/sizeloss_fs #\
   	  # results/segthor/fs  \
...
$(SIZES): OPT = --losses="[('CrossEntropy', {'idc': [1]}, None, None, None, 1),\
	('NaivePenalty', {'idc': [1]}, 'TagBounds', {'values': {1: [210, 7800]}, 'idc': [1]}, 'soft_size', 1e-2)]"

results/segthor/sizeloss_fs: OPT = --losses="[('CrossEntropy', {'idc': [1]}, None, None, None, 1),\
	('NaivePenalty', {'idc': [1]}, 'TagBounds', {'values': {1: [210, 7800]}, 'idc': [1]}, 'soft_size', 1e-2)]"
...
results/segthor/sizeloss_fs: DATA = --folders="$(B_DATA)+[('gt', gt_transform, True), ('gt', gt_transform, True)]"
