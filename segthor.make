...
# Training
$(SIZES): OPT = --losses="[('CrossEntropy', {'idc': [1]}, None, None, None, 1), ('DiceLoss', {'idc': [1]}, None, None, None, 1e-1),\
...
# --Full supervision
results/segthor/fs: OPT = --losses="[('CrossEntropy', {'idc': [1]}, None, None, None, 1), ('DiceLoss', {'idc': [1]}, None, None, None, 1e-1)]"
